...
| #    | Test                             | Expected Result                              | Status | Notes |
| ---- | -------------------------------- | -------------------------------------------- | ------ | ----- |
| 2.1  | Logo visible on desktop          | Brand image loads, correct size              |        |       |
...
| 2.5  | Dark mode toggle on desktop      | Toggles theme, correct icon shown            |        |       |
...
| 4.14 | Buy Now on dish card     | Navigates to /order                        |        |       |
...
| 5.4  | Category tabs          | Starters, Mains, Desserts, Drinks filter correctly |        |       |
...
| 5.8  | Dish card image        | Image loads or fallback shown                      |        |       |
...
| 5.14 | Buy Now button         | Navigates to /order                                |        |       |
...
| 6.2  | Invalid slug               | 404 page shown                                |        |       |
| 6.3  | Dish image                 | Full size image loads                         |        |       |
| 6.4  | Category + tag badges      | Visible under image                           |        |       |
...
| 8.6  | Coupon input                    | Accepts text, Apply button clickable                    |        |       |
...
| 14.8  | Forgot password link              | Link present (page can be placeholder)    |        |       |
...
| #    | Test                           | Expected Result                           | Status | Notes |
| ---- | ------------------------------ | ----------------------------------------- | ------ | ----- |
| 24.1 | Run Lighthouse on home page    | Score above 80 on all metrics             |        |       |
| 24.2 | Run Lighthouse on menu page    | Score above 80                            |        |       |
...
| #    | Test                               | Expected Result                  | Status | Notes |
| ---- | ---------------------------------- | -------------------------------- | ------ | ----- |
| 25.1 | Visit non-existent page            | 404 page shown                   |        |       |
| 25.2 | Visit /menu/invalid-slug           | 404 page shown                   |        |       |
